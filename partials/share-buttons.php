...
<section class="content-part article-share">
	<div class="article-share-inner">
		...
		<ul class="social-share-buttons">
			...
			<li class="share-facebook"><a title="Share on Facebook" href="https://www.facebook.com/dialog/share_open_graph?app_id=<?php echo $fb_app_id; ?>&display=popup&action_type=og.likes&action_properties=<?php echo urlencode( json_encode( array( "object" => $share_link ))); ?>&href=<?php echo $share_link; ?>&redirect_uri=<?php echo $share_link; ?>"><i class="fa fa-facebook" aria-hidden="true"></i></a></li>			
  ...
  '', 'menubar=no,toolbar=no,resizable=yes,scrollbars=yes,height=600,width=600');return false;"><i class="fa fa-google-plus" aria-hidden="true"></i></a></li>
			...
			<li class="share-linkedin"><a title="Share on LinkedIn" href="https://www.linkedin.com/shareArticle?mini=true&url=<?php echo $share_link; ?>&title=<?php echo $share_title; ?>&summary=<?php echo $share_description; ?>&source=<?php echo $linkedin_source; ?>"><i class="fa fa-linkedin" aria-hidden="true"></i></a></li>
			...
			<li class="share-twitter"><a title="Share on Twitter" href="https://twitter.com/intent/tweet?url=<?php echo $share_link; ?>&text=<?php echo $twitter_text; ?>&via=<?php echo $twitter_account; ?>"><i class="fa fa-twitter" aria-hidden="true"></i></a></li>
